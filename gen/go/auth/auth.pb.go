...
func (x *RegisterResponse) GetValid() bool {
	if x != nil {
		return x.Valid
	}
	return false
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x02 \x01(\tR\x06userId2z\n" +
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponseB6Z4github.com/1IQcoder/World-Of-Go/proto/auth;grpc_authb\x06proto3"
